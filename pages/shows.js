  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Browse popular TV shows in this Netflix-style demo."
        />
      ...
      <main>
        ...
        >
          ...
          <div className="hero__content">
            <h1 className="hero__title">Popular TV Shows</h1>
            <p className="hero__subtitle">
              Binge-worthy TV series from around the world.
            </p>
...
export async function getStaticProps() {
  ...
  const shows = normalizeItems(showsRaw).slice(0, 18);
